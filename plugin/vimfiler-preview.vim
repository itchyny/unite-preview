" =============================================================================
" Filename: vimfiler-preview.vim
" Version: 0.0
" Author: itchyny
" License: MIT License
" Last Change: 2013/03/18 19:53:21.
" =============================================================================
...
"       \ 'command': 'open %s'
"       \ }
" call s:new_preview_type(s:html)
...
function! s:auto_preview.func(candidate)
